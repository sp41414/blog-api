                    ...
                    <section className="py-8">
                        <div className="flex gap-2 border-b border-neutral-700 mb-6">
                            <button
                                ...
                                className={`px-6 py-3 font-semibold transition-colors duration-200 border-b-2 cursor-pointer ${activeTab === "published"
                            ...
                            <button
                                ...
                                className={`px-6 py-3 font-semibold transition-colors cursor-pointer duration-200 border-b-2 ${activeTab === "drafts"
                                        ? "border-emerald-500 text-emerald-500"
                                        : "border-transparent text-neutral-400 hover:text-neutral-200"
                                    }`}
                            >
